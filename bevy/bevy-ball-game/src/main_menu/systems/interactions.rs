use bevy::{app::AppExit, ecs::{event::EventWriter, query::{Changed, With}, schedule::NextState, system::{Query, ResMut}}, ui::{BackgroundColor, Interaction}};

use crate::{main_menu::{components::{PlayButton, QuitButton}, styles::{HOVERED_BUTTON_COLOR, NORMAL_BUTTON_COLOR, PRESSED_BUTTON_COLOR}}, AppState};
