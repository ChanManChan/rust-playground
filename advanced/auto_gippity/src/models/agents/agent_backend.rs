use super::agent_traits::{FactSheet, SpecialFunctions, RouteObject};
use crate::{
    ...
    helpers::{general::{
        ai_task_request, read_code_template_contents,
        read_exec_main_contents, save_backend_code, WEB_SERVER_PROJECT_PATH, check_status_code, save_api_endpoints,
    }, command_line::{PrintCommand, confirm_safe_code}},
    models::agents_basic::basic_agent::{AgentState, BasicAgent},
};
...
impl AgentBackendDeveloper {
    pub fn new() -> Self {
        let attributes = BasicAgent {
            objective: "Develops backend code for web server and json database".to_string(),
    ...
    async fn call_fixed_code_bugs(&mut self, fact_sheet: &mut FactSheet) {
        let msg_context: String = format!(
            ...
            match self.attributes.state {
                ...
                AgentState::Working => {
                    if self.bug_count == 0 {
                        ...
                        self.call_fixed_code_bugs(fact_sheet).await;
                    }
                ...
                AgentState::UnitTesting => {
                    ...
                    if !is_safe_code {
                        panic!("Choose better LLM next time...");
                    }
                    ...
                    // Convert API Endpoints in to values
                    ...
                    for endpoint in check_endpoints {
                        ...
                        match check_status_code(&client, &url).await {
                            ...
                            Err(e) => {
                                run_backend_server
                                    .kill()
                                    .expect("Failed to kil backend web server");
                    ...
                    run_backend_server
                        .kill()
                        .expect("Failed to kil backend web server on completion");
