...
pub async fn get_raw_clip(
    ...
    let req = service::ask::GetClip {
        ...
        password: cookies
            ...
            .flatten()
            .unwrap_or_else(<Password as Default>::default),
    };
...
pub mod test {
    ...
    fn error_on_missing_clip() {
        let client = client();
        let response = client.get("/clip/blahblasdasdasdasdh").dispatch();
    ...
    fn requires_password_when_applicable() {
        ...
        let clip = rt
            ...
            .expect("new clip request failed");
        ...
        let response = client
            .post(format!("/clip/raw/{}", clip.shortcode.as_str()))
            .cookie(Cookie::new("password", "123111"))
            .dispatch();
